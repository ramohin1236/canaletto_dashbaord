...
import { useCreateUpdatePropertyFileMutation } from '../../../../redux/property/propertyApis'
...
function AddSiteUpdate() {
  ...
  const [createPropertyFile, { isLoading }] = useCreateUpdatePropertyFileMutation()
