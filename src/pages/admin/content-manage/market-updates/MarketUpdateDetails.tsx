...
import { useGetSingleManageMarketQuery } from "../../../../redux/manageMarketApi/manageMarketApi";
import { Loader } from "lucide-react";

function MarketUpdateDetails() {
  const { id } = useParams();
  const { data: response, isLoading } = useGetSingleManageMarketQuery(id as string, {
    skip: !id,
  });
  ...
  const managerId = details?.contentManager?.id;
  ...
  return (
    <PageLayout title="Market Update Details">
      <div className="space-y-8">
              ...
              <div className="space-y-5">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div>
                        ...
                        >
                          <img src={InterestedClients} alt="View Profile" className="w-10 h-10 object-contain" />
                        </Link>
        ...
        >
           {/* If the description is an HTML string from a rich text editor it renders safely, otherwise renders string text */}
          <div 
