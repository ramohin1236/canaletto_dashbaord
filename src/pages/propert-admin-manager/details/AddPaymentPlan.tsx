      ...
      <PageContent>
        <FormalCard header={
          ...
          <Field className="mb-6">
            <FieldLabel className="text-base font-medium text-gray-600 block">Payment Plan Title </FieldLabel>
          ...
          {/* Image Upload */}
          <Field>
            <FieldLabel className="text-base font-medium text-gray-600 block">upload Payment Plan file</FieldLabel>
